...
class Whatsva 
{
    ...
    {
        $data = [];
        return $this->curlData($this->ws_url() . "/api/packages", $data);
    }
    public function DetailPackage($id)
    {
        ...
        return $this->curlData($this->ws_url() . "/api/package/detail", $data);
    }
    //transaction
    public function listTransactions()
    {
        $data = [];
        return $this->curlData($this->ws_url() . "/api/transactions", $data);
    }
    public function createTransactions($id_package)
    {
        ...
        return $this->curlData($this->ws_url() . "/api/transaction/create", $data);
    }
    //client
    public function clientDetail()
    {
        $data = [];
        return $this->curlData($this->ws_url() . "/api/client/detail", $data);
    }
    ...
    public function sendTemplateMessages($instance_key, $jid_group, $text,$footer,$imageUrl, $templateButtons, $panel_key)
    {
        ...
        $data = [
            ...
            , "panel_key" => $panel_key];
        // echo json_encode($data);
        $d = $this->curlData($this->ws_url() . "/api/sendTemplateMessages", $data);
