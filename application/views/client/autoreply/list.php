   ...
   <div class="container-fluid page-body-wrapper">
        ...
        <?php $this->load->view('layouts/navigasi',['menu'=>'autoreply']) ?>
        <!-- partial -->
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <a href="<?=base_url('/index.php/autoreply/add')?>" class="btn btn-sm btn-primary" style="margin-top:-35px;margin-right:-4px" >Add </a>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        $page2 = (int)$page + 1;
                          ...
                          <td>'.$value->receive.'</td>                     
                          <td>'.$value->reply.'</td>     
                          <td><a href="'.base_url("index.php/autoreply/".$value->id).'" class="btn btn-sm btn-info">Edit</a><br><a href="'.base_url("index.php/autoreply/delete/".$value->id).'" class="btn btn-sm btn-danger">Delete</a></td>
                        </tr>';
                          } ?>
