   ...
   <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <a href="<?=base_url('/index.php/group/add')?>" class="btn btn-sm btn-primary" style="margin-top:-35px;margin-right:-4px" >Add </a>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        $page2 = (int)$page + 1;
                          ...
                          <td>'.$i.'</td>
                          <td>'.$value->name.'</td>
                          <td>'.$value->contact_active.'</td>
                          <td>'.$value->deskripsi.'</td>    
                          <td>
                          <a href="'.base_url("index.php/contact?id_group=".$value->id).'" class="btn btn-sm btn-success">Contact</a>
                          <a href="'.base_url("index.php/group/".$value->id).'" class="btn btn-sm btn-info">Edit</a>
                          <a href="'.base_url("index.php/group/delete/".$value->id).'" class="btn btn-sm btn-danger">Delete</a></td>
                        </tr>';
                          } ?>
