                      ...
                      <tbody>
                        ...
                        $page2 = (int)$page + 1;
                          ...
                          foreach ($devices as $value) {
                              ...
                              $status_show = "";
                              $btn_scan = "";
                              $block = ($value->block == 0)?"true":"false";
                          ...
                          <td>
                          <a href="'.base_url("index.php/contact/edit/".$value->id."/".@$_GET['id_group']).'" class="btn btn-sm btn-info">Edit</a><br>
                          <a href="'.base_url("index.php/contact/delete/".$value->id."/".@$_GET['id_group']).'" class="btn btn-sm btn-danger">Delete</a></td>
                        </tr>';
                          } ?>
