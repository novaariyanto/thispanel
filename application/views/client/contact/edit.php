...
foreach ($group as $key => $value) {
    ...
    ?>
                                <option <?php echo ($value->id == $webhook->id_group)?'selected':''; ?> value="<?=$value->id?>"><?=$value->name?></option>
                                <?php }?>
                        </select>
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  name="name" id="name" placeholder="ex : Cabang A" value="<?=$webhook->name?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Number<br> <span style="color:red"> <?=form_error('number')?> <?php echo $this->session->flashdata('message_add_webhook_error'); ?></span></label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  name="number" id="number" placeholder="ex : member cabang" value="<?=$webhook->number?>"/>
                        </div>
                      </div>
