                        ...
                        $page2 = (int)$page + 1;
                          ...
                          foreach ($devices as $value) {
                              ...
                              if($status === "1"){
                                ...
                                $btn_scan = '<a class="btn btn-primary btn-sm" href="./device/authqr/'.$value->id.'"><i class="mdi mdi-qrcode-scan icon"></i></a><br><a class="btn btn-info btn-sm" href="./device/edit/'.$value->id.'">Edit</a><br><a class="btn btn-warning btn-sm" href="./device/delete/'.$value->id.'">Delete</a>';
                              }else if($status === "2"){
                                $status_show = '<label class="badge badge-info">Paired</label>';
                                $btn_scan = '<a class="btn btn-danger btn-sm" href="./device/logout/'.$value->id.'">Logout</a><br><a class="btn btn-info btn-sm" href="./device/edit/'.$value->id.'">Edit</a>';
                              }else{
