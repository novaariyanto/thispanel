...
foreach ($group as $key => $value) {
    ...
    ?>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="hidden" name="id_group" id="id_group" value="<?=$_GET['id_group']?>">
                          <input type="text" class="form-control"  name="name" id="name" placeholder="ex : Contact A" value="">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Number<br> <span style="color:red"> <?=form_error('deskripsi')?> <?php echo $this->session->flashdata('message_add_webhook_error'); ?></span></label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  name="number" id="number" placeholder="ex : 62895361034833" value=""/>
                        </div>
                      </div>
