   ...
   <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <a href="<?=base_url('/index.php/guest_contact/add?id_group=').@$_GET['id_group']?>" class="btn btn-sm btn-primary" style="margin-top:-35px;margin-right:-0px" >Add Manual</a> 
            <a href="<?=base_url('/index.php/guest_contact/import?id_group=').@$_GET['id_group']?>" class="btn btn-sm btn-info" style="margin-top:-35px;margin-right:-0px" >Import </a>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        $page2 = (int)$page + 1;
                          ...
                          <td>
                          <a href="'.base_url("index.php/guest_contact/delete/".$value->id."/".@$_GET['id_group']).'" class="btn btn-sm btn-danger">Delete</a></td>
                        </tr>';
                          } ?>
