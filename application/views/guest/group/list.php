   ...
   <div class="container-fluid page-body-wrapper">
        ...
        <?php $this->load->view('layouts/navigasi_guest',['menu'=>'group']) ?>
        <!-- partial -->
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <a href="<?=base_url('/index.php/guest_list/add')?>" class="btn btn-sm btn-primary" style="margin-top:-35px;margin-right:-4px" >Add </a>
