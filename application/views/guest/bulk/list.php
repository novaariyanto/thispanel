       ...
       <?php $this->load->view('layouts/navigasi_guest',['menu'=>'bulk']) ?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
           ...
           <a href="<?=base_url('/index.php/guest_bulk/add')?>" class="btn btn-sm btn-primary" style="margin-top:-35px;margin-right:-4px" >Add </a>
            <div class="row">
                   ...
                   <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                          ...
                          <td class="text-info ">
                          <a href="'.base_url("index.php/bulk/detail/".$value->id).'" class="btn btn-sm btn-success">Detail</a><br>
                        
                          <a href="'.base_url("index.php/bulk/".$value->id).'" class="btn btn-sm btn-info">Edit</a><br>
                          <a href="'.base_url("index.php/bulk/delete/".$value->id).'" class="btn btn-sm btn-danger">Delete</a></td>
