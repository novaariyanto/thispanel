...
?>
   ...
   <div class="container-fluid page-body-wrapper">
        ...
        <?php $this->load->view('layouts/navigasi_guest',['menu'=>'dashboard']) ?>
        <!-- partial -->
            ...
            <div class="row">
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    Remaining 
                    <h2 class="mb-3"> <span style="font-size:13pt">∞ Days</span> </h2>
                   
                   <a class="btn btn-bg btn-success float-left" href="<?=base_url('index.php/register')?>" onclick=" return confirm('are you sure ? to increase the active period ?')">Add Uptime</a>
                  </div>
                </div>
              </div>
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img  src="<?=base_url("assets/purple/assets/images/dashboard/circle.svg")?>"  class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Service you have <b>Guest Package</b><i class="mdi mdi-bookmark-outline mdi-24px float-right"></i></h4>
                      ...
                      <div class="col-4 d-none d-sm-block">
                        <div class="service-container">
                         ...
                         1 <span style="width:6px;"></span>
                            ...
                            <div class="mb-2"><br>
                             <b> <span class="text-numeric">1</span> </b>
                        ...
                        <div class="col-4 d-none d-sm-block">
                          ...
                          <div class="mb-3"><br>
                            <b><span class="text-numeric">100</span>
                            <span class="text-unit"> /Days</span></b>
                            </div>
                            <!-- <a href="#"><h5 style="color:white;">Lihat rincian</h5></a> -->
                        </div>
                      </div>
