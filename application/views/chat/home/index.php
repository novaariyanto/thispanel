...
<div class="home-page__content messages-page">
  <div class="container-fluid h-100">
    <div class="row px-0 h-100">
      ...
      <div class="col-12 col-md-4 col-lg-5 col-xl-3 px-0 messages-page__list-scroll">
        ...
        <div class="messages-page__search mb-0 px-3 pb-3">
          <div class="custom-form__search-wrapper">
            <input type="text" class="form-control custom-form" id="search" placeholder="Search..." autocomplete="off">
        ...
        <div >
        <center >
          <div class="spinner-border text-primary" role="status" id="loader-chat" style="display:none">
      ...
      <center id="welcome-chat">
        <img src="https://www.tme.net/wp-content/uploads/2020/03/whatsapp-web-e1583922317659.jpg" style="width:700px;heigth:600px;margin-top:20px" alt="">

        </center>
          <div class="chat__wrapper py-2 pt-mb-2 pb-md-3"  id="body-chat" style="display:none">
              ...
              <div class="chat__infos pl-2 pl-md-0" >
                <div class="chat-member__wrapper" data-online="false">
                  <div class="chat-member__avatar">
                    <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" alt="Whatsva" loading="lazy">
            ...
            <center >
          <div class="spinner-border text-primary" role="status" id="loader-chat2" style="display:none">
          <span class="sr-only">Loading...</span>
          </div>
            </center>
            ...
            <div class="chat__send-container px-2 px-md-3 pt-1 pt-md-3">
              ...
              <div class="custom-form__send-wrapper">
                <input type="hidden" name="instance_key" id="instance_key">
                <input type="hidden" name="jid" id="jid">
                
                <input name="message" type="text" class="form-control custom-form" id="message" placeholder="Type message …" autocomplete="off">
      ...
      <!-- end content section  -->
      <!-- start infos section  -->
      <div class="col-12 col-md-5 col-lg-4 col-xl-3 px-4 px-sm-5 px-lg-4 user-profile" style="display:none">
        ...
        <div class="user-profile__wrapper" >
          ...
          <div class="user-profile__details mt-1">
            ...
            <span class="user-profile__location">-</span>
          </div>
