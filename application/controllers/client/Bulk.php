...
class Bulk extends CI_Controller
{
    ...
    public function detail($id_group)
    {
        ...
        $this->load->view('client/bulk/detail', $data);
    ...
    public function index()
    {
        ...
        $this->load->view('layouts/header', $data);
        $this->load->view('client/bulk/list', $data);
        $this->load->view('layouts/footer');
    }
	public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layouts/header', $data);
            $this->load->view('client/bulk/add', $data);
            $this->load->view('layouts/footer');
            return;
        }
        ...
        if ($this->broadcast_model->add($broadcast_name,$device,$list,$message,$datetime)) {
            redirect('./bulk');
        } else {
    ...
    {   
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layouts/header', $data);
            $this->load->view('client/bulk/edit', $data);
            $this->load->view('layouts/footer');
            return;
        }
